      ...
      await api.createExperiment({
        ...
        topology: {
          ...
          nodes: [
            ...
            { node_id: "Task_Agent_A", node_type: "agent", system_prompt: "You are a helpful assistant.", tools: ["Tool_RAG_Vector"], metadata: {} },
            { node_id: "Task_Agent_B", node_type: "agent", system_prompt: "You are a security analyst.", tools: ["Tool_KnowledgeGraph"], metadata: {} },
            { node_id: "Tool_RAG_Vector", node_type: "tool", system_prompt: "", tools: [], metadata: {} },
            { node_id: "Tool_KnowledgeGraph", node_type: "tool", system_prompt: "", tools: [], metadata: {} },
          ],
          edges: [
            { source: "Gateway", target: "Task_Agent_A", edge_type: "direct" },
            { source: "Task_Agent_A", target: "Task_Agent_B", edge_type: "direct" },
            { source: "Task_Agent_A", target: "Tool_RAG_Vector", edge_type: "direct" },
            { source: "Task_Agent_B", target: "Tool_KnowledgeGraph", edge_type: "direct" },
          ],
          monitors: ["Auditor_Prime"],
          injections: [
            {
